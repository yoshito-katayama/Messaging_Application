...
const performGetQMAddress = async () => {
  try {
    ...
    const response = await fetch(`https://demo-2-mqdb2.apps.673a82dd2d681465a42b84fa.ocp.techzone.ibm.com/address`);
    /** エラーチェック **/
    if (!response.ok) {
...
const performSend = async (msg) => {
  try {
    ...
    const response = await fetch(
      `https://demo-2-mqdb2.apps.673a82dd2d681465a42b84fa.ocp.techzone.ibm.com/send?msg=${encodeURIComponent(msg)}`
    );
    /** エラーチェック **/
    if (!response.ok) {
      return { status: false, data: "Some errors occured" };
...
const performGet = async () => {
  try {
    ...
    const response = await fetch(`https://demo-2-mqdb2.apps.673a82dd2d681465a42b84fa.ocp.techzone.ibm.com/recv`);
    /** エラーチェック **/
    if (!response.ok) {
      return { status: false, data: "Some errors occured" };
    }
...
const performInsert = async (msg) => {
  try {
    ...
    const response = await fetch("https://demo-2-mqdb2.apps.673a82dd2d681465a42b84fa.ocp.techzone.ibm.com/insert", {
      method: "POST",
      headers: {
...
const performSelect = async () => {
  try {
    ...
    const response = await fetch(`https://demo-2-mqdb2.apps.673a82dd2d681465a42b84fa.ocp.techzone.ibm.com/check`);
    /** エラーチェック **/
    if (!response.ok) {
      return { status: false, data: "Some errors occured" };
    }
